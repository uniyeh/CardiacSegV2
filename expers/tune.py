...
if __name__ == "__main__":
    ...
    # Initialize Ray with the working directory to ensure workers can import expers module
    if not ray.is_initialized():
        ray.init(runtime_env={"working_dir": "/home/tcyeh3118/aicup_2025/content/CardiacSegV2"})
